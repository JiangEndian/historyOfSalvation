...
def alt2_common(request):
    ...
    if os.path.exists('language_voice_diction_korean/4web_restudy/已复习'):
...
#3、直到，查完事，结束并删除dump文件，生成已复习
    ...
    return render(request, 'alt2_common.html', my_dict)
...
def accept_cmd_alt2(request):
    ...
    return HttpResponseRedirect('/alt2-common')
