...
def create_database_link():
    ...
    global every_year
    global conn, cursor
    conn, cursor = opendb('language_voice_diction_mother/PlanDatabase.sqlite')
...
def mother_common(request):
    ...
    if os.path.exists('language_voice_diction_mother/4web_restudy/已复习') and not os.path.exists('language_voice_diction_mother/4web_restudy/common_info'):
        ...
        every_month_info = {}
        every_week_info = {}
        dump2file('language_voice_diction_mother/4web_restudy/every_year_info', every_year_info)
        dump2file('language_voice_diction_mother/4web_restudy/every_month_info', every_month_info)
        dump2file('language_voice_diction_mother/4web_restudy/every_week_info', every_week_info)
        
        common_info = common.find('Ymd', ymd)
        dump2file('language_voice_diction_mother/4web_restudy/common_info', common_info)
        close_database_link()
        ...
        return HttpResponseRedirect('http://47.244.31.34:3927/static/files/start.html') #复习完的直接回主页
    elif os.path.exists('language_voice_diction_mother/4web_restudy/common_info'):
        #every_year_info = loadffile('language_voice_diction_mother/4web_restudy/every_year_info')
        every_year_info = {}
        #every_month_info = loadffile('language_voice_diction_mother/4web_restudy/every_month_info')
        every_month_info = {}
        #every_week_info = loadffile('language_voice_diction_mother/4web_restudy/every_week_info')
        every_week_info = {}
        common_info = loadffile('language_voice_diction_mother/4web_restudy/common_info')
...
#3、直到，查完事，结束并删除dump文件，生成已复习
        ...
        os.remove('language_voice_diction_mother/4web_restudy/every_year_info')
        os.remove('language_voice_diction_mother/4web_restudy/every_month_info')
        os.remove('language_voice_diction_mother/4web_restudy/every_week_info')
        os.remove('language_voice_diction_mother/4web_restudy/common_info')
        write2file('language_voice_diction_mother/4web_restudy/已复习', '复习完成')
        return HttpResponseRedirect('/mother_common')
